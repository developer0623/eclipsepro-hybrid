...
eclipseProGeneratorService.$inject = ['eclipseProTheming', '$cookies'];
export function eclipseProGeneratorService(eclipseProTheming, $cookies) {
     ...
     */
    function generate() {
        let registeredThemes = eclipseProTheming.getRegisteredThemes();
        let registeredPalettes = eclipseProTheming.getRegisteredPalettes();
    ...
    function processAndStoreThemes(_themes) {
        ...
        let themes = angular.copy(_themes);
        ...
        eclipseProTheming.setThemesList(themes);

        // Remember selected theme.
        let selectedTheme = $cookies.get('selectedTheme');

        if (selectedTheme) {
            eclipseProTheming.setActiveTheme(selectedTheme);
        }
        else {
            eclipseProTheming.setActiveTheme('default');
        }
    }
    ...
    function rgba(color, _contrastLevel?) {
        let contrastLevel = _contrastLevel || false;
