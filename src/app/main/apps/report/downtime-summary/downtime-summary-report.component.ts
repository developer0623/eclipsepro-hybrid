...
import ReportTemplate from './downtime-summary-report.html';

const DowntimeSummaryReport_ = {
  selector: 'downtimeSummaryReport',
  bindings: {},
  template: ReportTemplate,
  /** @ngInject */
  controller: ['$mdPanel', '$filter', '$mdDialog', 'clientDataStore', 'apiResolver', 'appService', '$location', '$httpParamSerializer', class DowntimeSummaryReportComponent {
    _mdPanel;
    summaryList: any[] = [];
    filteredList: any[] = [];
      ...
      const sub_ = reportFilterSubject$
        ...
        .map(filters => {
          ...
          return Rx.Observable.fromPromise(
            apiResolver.resolve<any[]>('report.downtimeSummary@get', query)
          );
        })
        .switch()
        .subscribe(report => {
          ...
          <div id="print-content" class="print-content size-1117 pt-printer">
            <div class="page-content">
              <div class="print-content__main-titles">
                ...
                <div class="print-content__title2">Downtime Summary</div>
                <div class="print-content__title3">${this.factoryName}</div>
              </div>
              <div class="print-content__main-header">
                ...
                <div class="print-content__duration-title">GroupBy:</div>
                <div class="print-content__duration-content">${this.selectedGroup.name}</div>
                <div class="print-content__shift-title">ThenBy:</div>
                <div class="print-content__shift-content">${this.selectedThen.name}</div>
    ...
    openPrintPreview = ev => {
      ...
      const htmlStr = this.onAddPrintHeader(printContents);
...
export default DowntimeSummaryReport_;
