...
export function DowntimePopupController(
    ...
    let vm = this;
    vm.machinesData = new Map();
    machinesArray.forEach(y => {
      vm.machinesData[y.machineNumber] = y;
    });
